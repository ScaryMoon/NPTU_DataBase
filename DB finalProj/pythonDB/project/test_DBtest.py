...
# cursor.execute("create database test123")
...
cursor.execute(
    ...
    # ('C@神學','2','豬肉','L2','半'          ,'神學系辦'    ),
    # ('C@教育','3','兒童','L2','半'          ,'教育系辦'    ),
    # ('C@教育','1','心理學','L2','半'        ,'教育系辦'    ),
    # ('C@管理','3','管理學','L1','半'         ,'管理系辦'   ),
    # ('C@管理','1','原住民在地文化','L1','半','管理系辦'     )
    # """
    # "select * from course"
    ...
    # ('上午','東1','001',1999,'1','S001',  '$01','C@文'),
    # ('下午','東1','002',1999,'1','S002',  '$02','C@文'),
    # ('上午','東2','001',2000,'1','S003',  '$03','C@理'),
    # ('下午','東2','002',2000,'1','S004',  '$04','C@理'),
    # ('上午','東3','001',2000,'2','S005',  '$05','C@法'),
    # ('下午','東3','002',2000,'1','S006',  '$06','C@法'),
    # ('上午','西1','001',2011,'1','S007',  '$07','C@商'),
    # ('下午','西1','002',2011,'2','S008',  '$08','C@商'),
    # ('上午','西2','001',2012,'1','S009',  '$09','C@工'),
    # ('上午','西2','002',2012,'2','S010',  '$10','C@工'),
    # ('下午','西3','001',2012,'2','S011',  '$11','C@醫'),
    # ('上午','西3','002',2012,'2','S012',  '$12','C@醫'),
    # ('下午','南1','001',2013,'2','S013',  '$13','C@農'),
    # ('上午','南1','002',2013,'1','S014',  '$14','C@農'),
    # ('下午','南2','001',2014,'2','S015',  '$15','C@神學'),
    # ('上午','南2','002',2014,'1','S016',  '$16','C@神學'),
    # ('下午','北1','001',2014,'1','S017',  '$17','C@教育'),
    # ('上午','北1','002',2015,'1','S018',  '$18','C@教育'),
    # ('下午','北2','001',2015,'2','S019',  '$19','C@管理'),
    # ('上午','北2','002',2016,'2','S020',  '$20','C@管理')
    # """
...
# 改限制 也有可能語法 ALTER TABLE Customer ALTER COLUMN Addr char(30);
